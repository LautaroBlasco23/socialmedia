...
import socialmedia.backend.user.userAuth.dtos.UserLoginDTO;
...
import socialmedia.backend.user.userProfile.dtos.UpdatePasswordDTO;
...
public class UserAuthControllers {
    ...
    @PostMapping("/login")
    public ResponseEntity<?> login(HttpServletResponse response, @RequestBody UserLoginDTO loginData) {
        try {
    ...
    public ResponseEntity<?> register(@RequestBody UserRegisterDTO userData, BindingResult bindingResult, HttpServletResponse httpServletResponse) {
        try {
    ...
    public ResponseEntity<?> changePassword(@RequestBody UpdatePasswordDTO newPassword, BindingResult bindingResult, HttpServletRequest request) {
        try {
            ...
            Long userId = this.jwtTokenUtils.gettingUserIdFromRequest(request);
